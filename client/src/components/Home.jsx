      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-3xl shadow-2xl p-8 md:p-10">
          ...
          <div className="text-center mb-10">
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-indigo-400 to-purple-500 mb-5 shadow-lg shadow-purple-500/30">
          ...
          <div className="flex flex-col gap-3">
            ...
            <button
              disabled
              className="w-full py-4 rounded-2xl font-semibold text-white/40 text-lg bg-white/5 border border-white/10 cursor-not-allowed"
            >
              🏆 Leaderboard
              <span className="ml-2 text-xs bg-white/10 px-2 py-0.5 rounded-full">Soon</span>
            </button>
          </div>
